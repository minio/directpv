...
// ControllerServer contains controller server properties
...
// NewControllerServer returns the instance of ControllerServer with the provided properties
...
func (c *ControllerServer) CreateVolume(ctx context.Context, req *csi.CreateVolumeRequest) (*csi.CreateVolumeResponse, error) {
	...
	volumeInterface := c.directcsiClient.DirectV1beta5().DirectCSIVolumes()
	...
	if !matcher.StringIn(drive.Finalizers, finalizer) {
		...
		_, err = c.directcsiClient.DirectV1beta5().DirectCSIDrives().Update(
...
func (c *ControllerServer) DeleteVolume(ctx context.Context, req *csi.DeleteVolumeRequest) (*csi.DeleteVolumeResponse, error) {
	...
	directCSIClient := c.directcsiClient.DirectV1beta5()
