...
func TestListVolumes(t *testing.T) {
	...
	client.SetLatestDirectCSIVolumeInterface(cl.directcsiClient.DirectV1beta3().DirectCSIVolumes())
	client.SetLatestDirectCSIDriveInterface(cl.directcsiClient.DirectV1beta3().DirectCSIDrives())
