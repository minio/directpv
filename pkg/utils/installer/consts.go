...
const (
	...
	directCSILabel = "direct-csi-min-io"
	...
	certsDir                       = "/etc/certs"
	AdmissionWebhookDNSName        = "directcsi-validation-controller.direct-csi-min-io.svc"
	ConversionWebhookDNSName       = "directcsi-conversion-webhook.direct-csi-min-io.svc"
