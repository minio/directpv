...
// var _ rest.Interface = &DirectCSDriveAdapter{}
...
func (c *directCSIDriveAdapter) Get(
	...
	var converters []conversionFunc
	switch c.gvk.Version {
	case directcsi.Version:
		converters = append(converters, noop)
	case directcsiv1alpha1.Version:
		converters = append(converters, drivev1alpha1ToV1beta1)
		fallthrough
	case directcsiv1beta1.Version:
		converters = append(converters, drivev1beta1ToV1beta2)
		fallthrough
	case directcsiv1beta2.Version:
		converters = append(converters, drivev1beta2ToV1beta3)
	default:
		return nil, ErrUnsupportedConversion(c.gvk.Version, directcsi.Version)
	}

	intermediateResult := &directcsi.DirectCSIDrive{}
	_ = c.client.Get().
	...
	return runConversionChain(intermediateResult.ObjectType(), converters)
}

// drivev1alpha1ToV1beta1 converts runtime object from alpha1 to beta1
func drivev1alpha1ToV1beta1(from runtime.Object) (runtime.Object, error) {
	return converter.ConvertDirectCSIObject(from, versionV1Beta1)
}

// drivev1beta1ToV1beta2 converts runtime object from beta1 to beta2
func drivev1beta1ToV1beta2(from runtime.Object) (runtime.Object, error) {
	return converter.ConvertDirectCSIObject(from, versionV1Beta2)
}

// drivev1beta2ToV1beta3 converts runtime object from beta2 to beta3
func drivev1beta2ToV1beta3(from runtime.Object) (runtime.Object, error) {
	return converter.ConvertDirectCSIObject(from, versionV1Beta3)
}
...
func (c *directCSIDriveAdapter) List(ctx context.Context, opts v1.ListOptions) (result *directcsi.DirectCSIDriveList, err error) {
	...
	result = &directcsi.DirectCSIDriveList{}
	err = c.client.Get().
		Resource("directcsidrives").
