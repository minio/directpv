...
import (
	...
	clientset "github.com/minio/directpv/pkg/clientset/typed/direct.csi.min.io/v1beta5"
...
func removeVolumes(ctx context.Context, directCSIClient clientset.DirectV1beta5Interface, c *Config) error {
...
func removeDrives(ctx context.Context, directCSIClient clientset.DirectV1beta5Interface, c *Config) error {
	ctx, cancelFunc := context.WithCancel(ctx)
