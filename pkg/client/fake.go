...
import (
	...
	directcsiclientset "github.com/minio/directpv/pkg/clientset/typed/direct.csi.min.io/v1beta5"
...
func FakeInit() {
	...
	directCSIClient = directClientset.DirectV1beta5()
	...
	latestDirectCSIDriveInterface = directClientset.DirectV1beta5().DirectCSIDrives()
	latestDirectCSIVolumeInterface = directClientset.DirectV1beta5().DirectCSIVolumes()
