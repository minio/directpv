...
func TestGetDriveList(t *testing.T) {
	SetLatestDirectCSIDriveInterface(clientsetfake.NewSimpleClientset().DirectV1beta5().DirectCSIDrives())
	...
	SetLatestDirectCSIDriveInterface(clientsetfake.NewSimpleClientset(objects...).DirectV1beta5().DirectCSIDrives())
	drives, err = GetDriveList(context.TODO(), nil, nil, nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestGetVolumeList(t *testing.T) {
	SetLatestDirectCSIVolumeInterface(clientsetfake.NewSimpleClientset().DirectV1beta5().DirectCSIVolumes())
	...
	SetLatestDirectCSIVolumeInterface(clientsetfake.NewSimpleClientset(objects...).DirectV1beta5().DirectCSIVolumes())
	volumes, err = GetVolumeList(context.TODO(), nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
