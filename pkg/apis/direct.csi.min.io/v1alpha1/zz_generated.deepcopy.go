...
func (in *StorageTopologyLayout) DeepCopyInto(out *StorageTopologyLayout) {
	*out = *in
	...
	if in.DrivePaths != nil {
		in, out := &in.DrivePaths, &out.DrivePaths
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageTopologyNodeStatus) DeepCopyInto(out *StorageTopologyNodeStatus) {
	*out = *in
	out.AllocatedSize = in.AllocatedSize.DeepCopy()
	out.AvailableSize = in.AvailableSize.DeepCopy()
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageTopologyNodeStatus.
func (in *StorageTopologyNodeStatus) DeepCopy() *StorageTopologyNodeStatus {
	if in == nil {
		return nil
	}
	out := new(StorageTopologyNodeStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StorageTopologyStatus) DeepCopyInto(out *StorageTopologyStatus) {
	*out = *in
	if in.Nodes != nil {
		...
		*out = make([]StorageTopologyNodeStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	out.TotalAvailableSize = in.TotalAvailableSize.DeepCopy()
	out.TotalAllocatedSize = in.TotalAllocatedSize.DeepCopy()
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]StorageTopologyConditions, len(*in))
		copy(*out, *in)
