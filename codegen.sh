...
go install -v \
   k8s.io/code-generator/cmd/deepcopy-gen@v0.29.11 \
   k8s.io/code-generator/cmd/client-gen@v0.29.11 \
   k8s.io/code-generator/cmd/conversion-gen@v0.29.11
go install -v k8s.io/kube-openapi/cmd/openapi-gen@v0.0.0-20241105132330-32ad38e42d3f
go install -v sigs.k8s.io/controller-tools/cmd/controller-gen@v0.16.5
